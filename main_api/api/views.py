...
class MainBalanceManyAccounts(APIView):
    ...
    def get(self, request):
        response_data = [
            {self.ACCOUNT_NAME: "First account", self.BALANCE_NAME: 5_836_482},
            {self.ACCOUNT_NAME: "Second account", self.BALANCE_NAME: 15_104_856},
            {self.ACCOUNT_NAME: "Third account", self.BALANCE_NAME: 55_536_433},
            {self.ACCOUNT_NAME: "Fourth account", self.BALANCE_NAME: 1_536_433},
            {self.ACCOUNT_NAME: "Fifth account", self.BALANCE_NAME: 32_957_611},
            {self.ACCOUNT_NAME: "Sixth account", self.BALANCE_NAME: 13_954_414},
            {self.ACCOUNT_NAME: "Seventh account", self.BALANCE_NAME: 55_957_001},
        ]
